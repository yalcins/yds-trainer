...
export default function BootcampPage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (customRaw && typeof window !== 'undefined') {
    ...
    return (
      <div className="max-w-lg mx-auto px-4 py-8 space-y-4">
        <div className="card p-6 text-center space-y-3">
          ...
          <button
            onClick={() => { setQIdx(0); setPhase('sentence'); setScore({ correct:0, wrong:0, total:0, logicCorrect:0, logicTotal:0, directionCorrect:0, directionTotal:0 }) }}
